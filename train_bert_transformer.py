...
from pytorch_pretrained_bert import (WEIGHTS_NAME, CONFIG_NAME, BertTokenizer, BertAdam)
#from pytorch_pretrained_bert.modeling import BertOpenAIDoubleHeadsModel
...
def train():
    ...
    parser.add_argument("--log_dir", type=str, default="/home/rohola/codes/transfer-learning-conv-ai/logs/logs7", help="Local rank for distributed training (-1: not distributed)")
    ...
    model = BertOpenAIDoubleHeadsModel.from_pretrained(args.model_checkpoint)
